...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/index-avatar.tsx":[function(require,module,exports) {
var HalftoneElement = document.getElementById("profile");
var landing = document.querySelector(".landing--word");
var word = landing.querySelector(".word");
var definition = landing.querySelector("p");
var windowInnerHeight = window.innerHeight; // So we want to detect if a element is in the middle
...
function getStep(input, total, from, to, step) {
  if (input === void 0) {
    input = 0;
  }
  ...
  var percentage = (total - input) * 100 / total;
  var inStepPercentage = (from - to) * 100 / (from - to);
  var inStep = percentage / inStepPercentage * step;
  return inStep < 0 ? inStep * -1 : inStep;
}

window.addEventListener("scroll", function () {
  return window.requestAnimationFrame(function () {
    var _a = landing.getBoundingClientRect(),
        top = _a.top,
        bottom = _a.bottom;
    ...
    var middle = top + landing.clientHeight; // ((input - min) * 100) / (max - min)

    var step = getStep(middle, windowInnerHeight - 100, 0, 5, 0.1).toFixed(3) * 100;
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","src/index-avatar.tsx"], null)
//# sourceMappingURL=/index-avatar.76a4ff0a.js.map